...
export default function AboutPage() {
  return (
    <div className="w-full">
      {/* 1. Intro Section */}
      <div className="max-w-screen-xl mx-auto px-6 py-20 md:py-32 flex flex-col items-center text-center">
        ...
        <div className="max-w-3xl text-gray-600 leading-loose mx-auto animate-fade-in-up delay-400">
            <p className="mb-6">
                아트현은 공공미술, 공공디자인, 벽화 등 다양한 예술 활동을 통해 도시의 이야기를 시각화하고 
                지역 사회에 활력을 불어넣는 <strong>문화예술 전문 사회적기업</strong>입니다.
            </p>
            <p>
                단순한 환경 개선을 넘어, 예술이 가진 힘으로 공간의 가치를 재발견하고 
                주민들의 삶 속에 스며드는 따뜻한 문화를 만들어갑니다.
            </p>
        </div>
      </div>
